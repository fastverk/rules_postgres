fn main() {
    cc::Build::new()
        .file("c_oracle/renamed_interval.c")
        ...
        .warnings(false)
        .opt_level(2)
        .compile("pg_interval_c");

    println!("cargo:rerun-if-changed=c_oracle/interval.c");
    println!("cargo:rerun-if-changed=c_oracle/renamed_interval.c");
